...
cd ~/Desktop/ECE1779_Projects/ECE1779/A2
...
./venv/bin/gunicorn -w 1 "app:create_app()" -e FLASK_ENV=production -b 0.0.0.0:5000 -t 120 --access-logfile logs/access.log --error-logfile logs/error.log